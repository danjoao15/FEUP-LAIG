 ...
 * @param     z2
 */
 // MyTriangle(scene, x0, y0, z0, x1, y1, z1, x2, y2, z2)
function MyTriangle(scene, a) {
	...
	this.z2=this.args[8];
 	...
 	this.setTex = false;
    this.p1 = [this.x0, this.y0, this.z0];
    this.p2 = [this.x1, this.y1, this.z1];
    this.p3 = [this.x2, this.y2, this.z2];
	this.initBuffers();
 };
