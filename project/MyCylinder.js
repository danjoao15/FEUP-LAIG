 ...
 * @constructor
 */
// function MyCylinder(scene,  height, bottomradius, topradius, stacks, slices, topcap, bottomcap) {
 function MyCylinder(scene, a){
	...
	this.topFlag = this.args[5];
	this.botFlag = this.args[6];
...
MyCylinder.prototype.amplify = function (sFactor, tFactor) {};
